...
export class Catalogoservice {
  ...
  GetLocalidades(){
    const uri = 'http://localhost/Beneficios/api/v0/Beneficios/Localidad';
    return this.http.get(uri);
  }
  
  GetAreas(){
    const uri = 'http://localhost/Beneficios/api/v0/Beneficios/Area';
    return this.http.get(uri);
  }

  GetCargos(){
    const uri = 'http://localhost/Beneficios/api/v0/Beneficios/Cargo';
    return this.http.get(uri);
  }

  GetRoles(){
    const uri = 'http://localhost/Beneficios/api/v0/Beneficios/Roles';
    return this.http.get(uri);
  }

  GetBeneficios(){
    const uri = 'http://localhost/Beneficios/api/v0/Beneficios/Beneficio';
    return this.http.get(uri);
  }
